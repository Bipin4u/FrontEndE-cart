...
import Paginater  from "../../common/layout/Paginater";
...
function Products() {
    ...
    useEffect(() => {    
        console.log(`http://127.0.0.1:8000/api/category/${category}/?page=${pagenumber}&sort=${sort}`)
      axios.get(`http://127.0.0.1:8000/api/category/${category}/?page=${pagenumber}&sort=${sort}`)
        .then(res => {
